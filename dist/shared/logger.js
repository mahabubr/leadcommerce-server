...
const logger = (0, winston_1.createLogger)({
    ...
    transports: [
        ...
        new winston_daily_rotate_file_1.default({
            filename: path_1.default.join(process.cwd(), 'logs', 'winston', 'successes', 'CU-%DATE%-success.log'),
...
const errorLogger = (0, winston_1.createLogger)({
    ...
    transports: [
        new winston_1.transports.Console(),
        new winston_daily_rotate_file_1.default({
            filename: path_1.default.join(process.cwd(), 'logs', 'winston', 'errors', 'CU-%DATE%-error.log'),
            datePattern: 'HH-DD-MM-YYYY',
            zippedArchive: true,
            maxSize: '20m',
            maxFiles: '14d',
